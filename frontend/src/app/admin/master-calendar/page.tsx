                                    ...
                                    >
                                        ...
                                        <div className="mobile-day-indicators">
                                            {dayContent.map(item => (
                                                ...
                                                >
                                                    {item.freelancer_name ? item.freelancer_name.substring(0, 3).toUpperCase() : getClientAbbreviation(item.clients?.company_name)}
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '2px' }}>
                                    ...
                                    {selectedItem.item.freelancer_name ? (
                                        <span style={{ fontSize: '12px', fontWeight: 600, color: 'var(--text-secondary)' }}>{selectedItem.item.freelancer_name}</span>
                                    ) : (
